...
int main(int argc, char** argv)
{
	...
	// Update this URL to reflect your google sheets URL
	char url_string[] = 
		"https://script.google.com/macros/s/AKfycbyU-SbCo_NxwmbkkcVfm2dShBgkhYgGv3p1P2uu6B9xyaM7Wkc/exec";
	...
	while (1)
	{
		...
		if (isDataReady == 1)
		{
			...
			sprintf(cloud_buffer, "curl -L %s?Temp=%3.1f'&'Threshold=%u", url_string, Temp, threshold); 
			system(cloud_buffer);
		}
		else
		{
