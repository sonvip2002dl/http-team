 ...
 ***************************************************
 *
 * FILE NAME  :  M3_L3_T3_gyroscope.c
 * DESCRIPTION:  This program reads Gyroscope values and produce an output file
 *
 **************************************************/
