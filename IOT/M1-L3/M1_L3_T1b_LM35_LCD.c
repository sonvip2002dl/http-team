 ...
 ***************************************************
 *
 * FILE NAME  :  M1_L3_T1b_LM35_LCD.c      
 * DESCRIPTION:  This code converts the digital signal
 *               from ADC into temperature value and 
 *               displays on the LCD. 
 *
 ***************************************************/
...
int main()
{
	...
	while (1)
	{
		sprintf (buf, "Temp: %3.1f%cC", ((((float) GetMCP3208 (7)) * 3300 / 4096)-500)/10, 0xDF);
